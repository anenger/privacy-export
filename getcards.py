...
questions = [
	...
	},
	{
		'type': 'confirm',
		'name': 'privacyUnused',
		'message': 'Would you like to get all privacy cards, or just the unused?',
		'when': lambda answers: answers['cardProvider'] == 'privacy'
	},
	{
		'type': 'input',
...
if __name__ == "__main__":
	...
	generator = Generator(firstname, lastname, promptsettings['email'], promptsettings['phoneNumber'], promptsettings['addressLine1'],
	promptsettings['addressLine2'], promptsettings['city'], promptsettings['state'], promptsettings['zipCode'], promptsettings['emailPrefix'],
	promptsettings['nameJig'], promptsettings['phoneJig'], promptsettings['addressJig'])

	if (promptsettings['cardProvider'] == "privacy"):
		cardsession = PrivacySession(promptsettings['privacyEmail'], promptsettings['privacyPassword'])
		...
		if (promptsettings['stripeNewCards'] == "new"):
			print("Generating {0} cards with cardholder {1}".format(promptsettings['stripeValue'], promptsettings['stripeCardholder']))
	...
	elif (promptsettings['cardProvider'] == "own"):
